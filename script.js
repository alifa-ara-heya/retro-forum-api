...
const handleCount = () => {
    const previousCountStr = document.getElementById('markAsReadCounter').innerText;
    const previousCountNum = parseInt(previousCountStr);
    const sum = previousCountNum + 1;
        ...
        <div class="card lg:w-96 pb-5 bg-base-100 shadow-2xl">
          ...
          <div class="p-5 lg:p-10 space-y-4 lg:space-y-5">
            <p class="opacity-50 text-start">
              <i class="fa-solid fa-calendar-days me-2"></i>${latestPost.author.posted_date?latestPost.author.posted_date:"No Publish Date"}
            </p>
